...
public class GameTile : MonoBehaviour
{
    ...
    private Quaternion _northRoration = Quaternion.Euler(90f, 0f, 0f);
    private Quaternion _southRoration = Quaternion.Euler(90f, 180f, 0f);
    private Quaternion _eastRoration = Quaternion.Euler(90f, 90f, 0f);
    private Quaternion _westRoration = Quaternion.Euler(90f, 270f, 0f);
    ...
    public void ShowPath()
    {
        ...
        _arrow.localRotation =
            _nextOnPath == _north ? _northRoration :
            _nextOnPath == _east ? _eastRoration :
            _nextOnPath == _south ? _southRoration :
            _westRoration;
    }
}
